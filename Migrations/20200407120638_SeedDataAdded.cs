    ...
    public partial class SeedDataAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Black teas", "Includes Assam, Ceylon, Darjeeling, Keemun and Yunnan teas" },
                    { 2, "Green teas", "Includes Sencha, Matcha, Jasmine, Gunpowder teas" },
                    { 3, "White teas", "Includes Silver Needle, White Peony, Summer Rain teas" },
                    { 4, "Yellow teas", "Includes Hunan, Zhejiang and Sichuan teas" },
                    { 5, "Fruit pies", null },
                    { 6, "Cheese cakes", null },
                    { 7, "Seasonal pies", null }
                });
